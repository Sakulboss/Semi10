...
mel_spectrogram = librosa.feature.melspectrogram(y = y, sr = sr, fmin = 0, fmax= 2000, hop_length = 100)
...
librosa.display.specshow(mel_spectrogram_db, x_axis = None, y_axis = 'mel', sr = sr) #'time'
plt.colorbar(format='%+2.0f dB')
plt.title('Mel Spectrogram')
plt.show()
